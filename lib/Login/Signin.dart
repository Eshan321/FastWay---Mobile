import 'package:Mobile_FastWay/Login/Signup.dart';
import 'package:Mobile_FastWay/Mobile/MobileHome.dart';
  ...
  Future<void> signIn() async{
    ...
    if(formState.validate()){
      ...
      try{
        ...
        assert(user != null);
        Navigator.push(context,MaterialPageRoute(builder: (context) => MobileHome(), fullscreenDialog: true));
      }catch (e){
        print(e.message);
      }
    }
